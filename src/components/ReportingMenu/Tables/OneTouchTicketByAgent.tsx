...
export const columns: ColumnDef<Payment>[] = [
  ...
  {
    accessorKey: 'avg_one_ticket',
    header: () => <div className='text-right'>Avg. One Ticket %</div>,
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue('avg_one_ticket')).toFixed(2)
...
export function OneTouchTicketByAgent() {
