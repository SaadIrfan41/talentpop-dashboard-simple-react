...
export const columns: ColumnDef<Payment>[] = [
  ...
  {
    accessorKey: 'avg_message_sent',
    header: () => <div className=' text-center'>Avg Message Sent</div>,
    cell: ({ row }) => {
      const amount = parseFloat(row.getValue('avg_message_sent')).toFixed(2)
...
export function RollingAvgMessagesSentByAgent() {
