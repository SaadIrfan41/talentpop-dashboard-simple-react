...
const getInternalTeamHighActivityReport = async (
  ...
  try {
    const res = await fetch(
      `http://44.240.77.70:8000/high-activity-rate-report-internal-team?${clientQueryParam}&${agentsQueryParam}&${teamLeadQueryParam}&${OM_QueryParam}&${CSM_QueryParam}&startdate=${startingDateFilter}&enddate=${endingDateFilter}`,
      {
        headers: {
